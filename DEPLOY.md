...
| `DATABASE_URL` | `sqlite://./data/ace-cast.db` | Persistence. `sqlite://<file>` locally; `postgres://…` in production (e.g. a managed Postgres). Selects the DB dialect automatically. |
