"""Maturity ceilings reach creative and review stages without prescribing a shared voice."""
import pytest
...
def test_stages_receive_ceiling_without_creative_direction(settings, sample_theme, sample_candidates, sample_moderated, ceiling):
    ...
    for call in llm.calls:
        ...
        assert "limit, not a target tone" in call["system"]
